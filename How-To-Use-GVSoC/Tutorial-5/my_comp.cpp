...
class MyComp : public vp::Component
{
    ...
    private:
        ...
        // Create an internal 32-bit register
...
MyComp::MyComp(vp::ComponentConf &config)
    ...
    // The vcd_value signal belongs to my_comp, it has the name status, and it is 32 bits wide
    // The my_reg register belongs to my_comp, it has the name my_reg, and it is 32 bits wide
{
...
vp::IoReqStatus MyComp::handle_req(vp::Block *__this, vp::IoReq *req)
{
    ...
    */
    if (!req->get_is_write())
    {
        ...
        // Handle register 0x04. We do not need to add any actual new register, since we already define a range of address for my_comp when we connect it with ico.
        // Here the behaviour is to return the value*2 when the request is at offset 0x4, and the size of the request is 4 bytes.
    ...
    else if (req->get_is_write()) // If request is write rather than read (main.c is modified for Tutorial 4)
    {
        ...
        int value = 5; // This is just an example, you can set any condition you want
