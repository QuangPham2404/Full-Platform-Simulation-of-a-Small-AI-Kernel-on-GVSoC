...
class Soc(gvsoc.systree.Component):
    def __init__(self, parent, name, binary):
        ...
        # Create the second cpu and connecting it to the interconnect.
        host2 = cpu.iss.riscv.Riscv(self, 'host2', isa='rv64imafdc', binaries=[binary])
        host2.o_DATA(ico.i_INPUT())
        host2.o_FETCH(ico.i_INPUT())
        host2.o_DATA_DEBUG(ico.i_INPUT())
        # We also need to connect loader to the second cpu
